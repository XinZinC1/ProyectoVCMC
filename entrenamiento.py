...
modelo = Sequential()
modelo.add(Conv2D(32, (3, 3), activation='relu', input_shape=(tamaño_img, tamaño_img, 1)))
...
modelo.fit(x_train, y_train, epochs=5, batch_size=32, validation_data=(x_test, y_test), callbacks=[early_stopping, model_checkpoint])